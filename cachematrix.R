...
## 3. setinverse(): to set the inverse value of matrix
## 4. getinverse(): to get the inverse value of matrix
## The "<<-" operator has been used in "set()" and "setinverse()" functions causing a 
## search to be made through parent environments for an existing definition of the 
